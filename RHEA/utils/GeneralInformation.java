...
public class GeneralInformation {
	...
	public LinkedList<Action> startAvailActions; // can use action
	public LinkedList<Action> myStartHitActions; // the action of enough Energy
	...
	public EmcmAiMax emcmAiMax;
	public boolean isEmcmAiMaxFlag;
	public boolean isUseEmcmAiMaxFlag;
	public int evolveTimes = 0;
	public int AllEvolveTimes = 0;
	...
	public GeneralInformation(GameData gd, boolean selfplayer, String lossType, boolean specificEnemy) {
		...
		emcmAiMax = new EmcmAiMax();
		emcmAiMax.initialize(gd, selfplayer);
	}
