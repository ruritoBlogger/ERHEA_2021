...
//	// For ZEN
	...
	// TODO ------------------------------------------------------------------------------------------------
	public static final Action[] actionAir_speedmode = new Action[]{Action.AIR_A, Action.AIR_B, Action.AIR_D_DB_BA, // 3
			Action.AIR_D_DB_BB, Action.AIR_D_DF_FA, Action.AIR_D_DF_FB, Action.AIR_DA, Action.AIR_DB, // 5
			Action.AIR_F_D_DFA, Action.AIR_F_D_DFB, Action.AIR_FA, Action.AIR_FB, Action.AIR_UA, Action.AIR_UB, // 6
	};

	public static final Action[] actionGround_speedmode = new Action[]{
			Action.CROUCH_A, Action.CROUCH_B, Action.CROUCH_FA, Action.CROUCH_FB, // 4
			Action.STAND_A, Action.STAND_B, Action.STAND_D_DB_BA, Action.STAND_D_DB_BB, Action.STAND_D_DF_FA, // 5
			Action.STAND_D_DF_FB, Action.STAND_D_DF_FC, Action.STAND_F_D_DFA, Action.STAND_F_D_DFB, Action.STAND_FA, // 5
			Action.STAND_FB, Action.THROW_A, Action.THROW_B }; // 3

	public static final Action[] actionGroundZEN_speedmode =
			new Action[] {
					Action.CROUCH_B, Action.FOR_JUMP, Action.BACK_JUMP
			};

	public static final Action[] actionAirZEN_speedmode =
			new Action[] {
					Action.AIR_DB, Action.AIR_B, Action.AIR_DA, Action.AIR_D_DB_BB, Action.AIR_D_DB_BA, Action.AIR_D_DF_FB
			};

	public static final Action[] actionGroundGAR_speedmode =
			new Action[] {
					Action.FOR_JUMP, Action.STAND_D_DF_FB, Action.BACK_JUMP, Action.CROUCH_FB, Action.CROUCH_A, Action.STAND_B,
			};

	public static final Action[] actionAirGAR_speedmode =
			new Action[] {
					Action.AIR_DB, Action.AIR_A, Action.AIR_B
			};

	public static final Action[] actionGroundOther_speedmode =
			new Action[] {
					Action.CROUCH_B, Action.STAND_A, Action.STAND_F_D_DFA, Action.STAND_D_DB_BB, Action.THROW_B
			};

	public static final Action[] actionAirOther_speedmode =
			new Action[] {
					Action.AIR_GUARD,
					Action.AIR_A, Action.AIR_B,
					Action.AIR_FA, Action.AIR_FB,
	...
	public static final Action[] actionGroundZEN_stardmode =
			new Action[] {
					Action.CROUCH_FB,
					Action.STAND_B,
					Action.FOR_JUMP, Action.BACK_JUMP
			};

	public static final Action[] actionAirZEN_stardmode =
			new Action[] {
					Action.AIR_B,
					Action.AIR_DA,
					Action.AIR_DB,
...
//	public static final Action[] actionGroundGAR_stardmode =
//			new Action[] {
//					Action.CROUCH_A,
//					Action.CROUCH_B,
//					Action.STAND_A,
...
//			};
//
//	public static final Action[] actionAirGAR_stardmode =
//			new Action[] {
//					Action.AIR_A,
//					Action.AIR_B,
//					Action.AIR_D_DF_FA,
...
//			};
	...
	public static final Action[] actionGroundOther_stardmode =
			new Action[] {
					Action.CROUCH_A,
					Action.CROUCH_B,
					Action.CROUCH_FA,
	...
	public static final Action[] actionAirOther_stardmode =
			new Action[] {
					Action.AIR_A,
					Action.AIR_DB,
